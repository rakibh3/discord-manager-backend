...
- **WHEN** a submission carries a name of at least 3 characters, a valid Bangladeshi mobile number, a well-formed email, and a valid Discord handle
...
- **WHEN** the full name is shorter than 3 characters, or contains anything other than letters and spaces
