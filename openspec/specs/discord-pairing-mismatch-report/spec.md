# discord-pairing-mismatch-report Specification

## Purpose

TBD — being authored as part of the discord-username-persistence-and-admin-override change. The capability records, displays, and lets administrators close out reports of attendance submissions whose submitted handle did not match the recorded Discord pairing for the same email, which is the path through which a student who cannot enter their real handle still gets today's attendance recorded while an administrator investigates.
